...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section grid gap-6 p-6 max-w-[1200px] w-full mx-auto select-none relative"
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {cardData.map((card, index) => {
            const baseClassName = `card flex flex-col justify-between relative aspect-[16/9] min-h-[200px] w-full max-w-full p-5 rounded-[20px] border border-solid font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] ${
            ...
            return (
              <div
                key={index}
                className={baseClassName + " bg-accent-a0 dark:bg-primary-a0 "}
                style={cardStyle}
                ref={(el) => {
                  if (!el) return;
